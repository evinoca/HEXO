---
title: 进程与线程的一个简单解释
date: 2016-06-29 17:22:07
categories: Basic Knowledge
tags: Thread and Process
---

进程和线程的概念，查了无数遍还是没有办法在被问起的时候说明白。

这看到一个文章浅显易懂得不得了，摘录一下
...
这时的解决方法，就是在门口挂n把钥匙。进去的人就取一把钥匙，出来时再把钥匙挂回原处。后到的人发现钥匙架空了，就知道必须在门口排队等着了。这种做法叫做["信号量"](http://en.wikipedia.org/wiki/Semaphore_%28programming%29)（Semaphore），用来保证多个线程不会互相冲突。
